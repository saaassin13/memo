...
### Step 19.1: 数据层
- [ ] 扩展 Goal 实体 (计算属性: progress, isCompleted, isOverdue, daysRemaining)
- [ ] 创建 GoalProgressLog 实体
- [ ] 新增 goal_progress_logs 表
- [ ] 升级数据库版本 (v6 → v7)
- [ ] 更新仓储接口和实现

### Step 19.2: 状态管理
- [ ] 创建 goal_providers.dart
- [ ] 实现 goalsProvider
- [ ] 实现 goalFilterProvider + goalSortProvider
- [ ] 实现 filteredGoalsProvider
- [ ] 实现 goalStatsProvider
- [ ] 实现 goalProgressLogsProvider

### Step 19.3: 组件开发
- [ ] 创建 ProgressRing 进度环组件
- [ ] 创建 GoalCard 目标卡片组件
- [ ] 创建 GoalEditDialog 新建/编辑弹窗
